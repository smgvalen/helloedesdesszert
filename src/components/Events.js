            ...
            <div className="container" data-aos="fade-up">
                ...
                <div className="swiper-wrapper">
                    ...
                    <div className="row event-item">
                        ...
                        <img src="assets/img/event-birthday.jpg" className="img-fluid" alt=""></img>
                        </div>
                    ...
                    <div className="row event-item">
                        <div className="col-lg-6">
                        <img src="assets/img/event-private.jpg" className="img-fluid" alt=""></img>
                        </div>
                        <div className="col-lg-6 pt-4 pt-lg-0 content">
                    ...
                    <div className="row event-item">
                        <div className="col-lg-6">
                        <img src="assets/img/event-custom.jpg" className="img-fluid" alt=""></img>
                        </div>
                        <div className="col-lg-6 pt-4 pt-lg-0 content">
