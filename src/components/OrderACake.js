function OrderACake() {
    ...
    return (
        <section id="order-a-cake" className="order-a-cake">
            <div className="container" data-aos="fade-up">
                ...
                <form action="forms/order-a-cake.php" method="post" role="form" className="php-email-form"
