                ...
                <div className="col-lg-9 mt-4 mt-lg-0">
                    ...
                    <div className="tab-pane active show" id="tab-1">
                        ...
                        <div className="col-lg-4 text-center order-1 order-lg-2">
                            <img src="assets/img/specials-1.png" alt="" className="img-fluid"></img>
                        </div>
                        </div>
                    </div>
                    <div className="tab-pane" id="tab-2">
                        ...
                        <div className="col-lg-4 text-center order-1 order-lg-2">
                            <img src="assets/img/specials-2.png" alt="" className="img-fluid"></img>
                        </div>
                        </div>
                    </div>
                    <div className="tab-pane" id="tab-3">
                        ...
                        <div className="col-lg-4 text-center order-1 order-lg-2">
                            <img src="assets/img/specials-3.png" alt="" className="img-fluid"></img>
                        </div>
                        </div>
                    </div>
                    <div className="tab-pane" id="tab-4">
                        ...
                        <div className="col-lg-4 text-center order-1 order-lg-2">
                            <img src="assets/img/specials-4.png" alt="" className="img-fluid"></img>
                        </div>
                        </div>
                    </div>
                    <div className="tab-pane" id="tab-5">
                        ...
                        <div className="col-lg-4 text-center order-1 order-lg-2">
                            <img src="assets/img/specials-5.png" alt="" className="img-fluid"></img>
                        </div>
                        </div>
                    </div>
                    </div>
